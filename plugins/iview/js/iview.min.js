...
(function (d, v, q) {
    ...
    var B = function (a, b) {
        ...
        c.slides.each(function () {
            ...
            if ("video" == a.data("iview:type")) {
                var f = a.children().eq(0), e = d('<div class="iview-video-show"><div class="iview-video-container"><a class="iview-video-close" title="' +
                b.closeLabel + '">&#735;</a></div></div>');
                a.append(e);
                f.appendTo(d("div.iview-video-container", e));
                e.css({width: c.defs.width, height: c.defs.height, top: "-" + c.defs.height + "px"}).hide();
                a.addClass("iview-video").css({cursor: "pointer"})
            }
            c.defs.total++
        }).css({width: c.defs.width, height: c.defs.height});
        c.sliderContent.append('<div id="iview-preloader"><div></div></div>');
        var f = d("#iview-preloader", c.sliderContent), e = d("div", f);
        f.css({top: c.defs.height / 2 - f.height() / 2 + "px", left: c.defs.width / 2 - f.width() / 2 + "px"});
        ...
        if (1 < c.defs.total && "bar" != c.defs.timer) {
            ...
            c.R = k / 2;
            var n = {stroke: b.timerBg, "stroke-width": h + 2 * g}, D = {
                    stroke: b.timerColor,
                    "stroke-width": h,
                    "stroke-linecap": "round"
                }, m = {fill: b.timerColor, stroke: "none", "stroke-width": 0},
                o = {fill: b.timerBg, stroke: "none", "stroke-width": 0};
            l.customAttributes.arc = function (a, b) {
                var c = 1 * a, d = (90 - c) * Math.PI / 180, f = k / 2 + g + h, e = k / 2 + g + h, i = f + b * Math.cos(d), d = e - b * Math.sin(d);
                return {path: 360 == a ? [["M", f, e - b], ["A", b, b, 0, 1, 1, 299.99, e - b]] : [["M", f, e - b], ["A", b, b, 0, +(180 < c), 1, i, d]]}
            };
            l.customAttributes.segment = function (a, b) {
                ...
                return {
                    path: [["M", f, e], ["l", b * Math.cos(c), b * Math.sin(c)], ["A", b, b, 0, +d, 1, f + b * Math.cos(a), e + b * Math.sin(a)],
                        ["z"]]
                }
            };
        ...
        1 < c.defs.total && "360bar" == c.defs.timer && c.timerBgPath.attr({arc: [359.9, c.R]});
        "bar" == c.defs.timer ? (c.iviewTimer.css({
            ...
            width: 0, height: h,
            background: b.timerColor, "float": "left"
        })) : c.iviewTimer.css({opacity: b.timerOpacity, width: i, height: j});
        c.setTimerPosition();
        new r(c.defs.images, function (a) {
            a = a * 10;
            e.stop().animate({width: a + "%"})
        }, function () {
            e.stop().animate({width: "100%"}, function () {
                f.remove();
                c.startSlider();
        ...
        d(".iview-video", c.slider).click(function (a) {
            ...
            if (!d(a.target).hasClass("iview-video-close") && !d(a.target).hasClass("iview-caption") && !d(a.target).parents().hasClass("iview-caption")) {
                b.show().animate({top: 0}, 1E3, "easeOutBounce");
    ...
    B.prototype = {
        timer: null, startSlider: function () {
            ...
            a.options.directionNav && (a.sliderContent.append('<div class="iview-directionNav"><a class="iview-prevNav" title="' + a.options.previousLabel + '">' + a.options.previousLabel + '</a><a class="iview-nextNav" title="' + a.options.nextLabel + '">' + a.options.nextLabel + "</a></div>"), d(".iview-directionNav", a.sliderContent).css({opacity: a.options.directionNavHoverOpacity}),
                a.sliderContent.hover(function () {
                    d(".iview-directionNav", a.sliderContent).stop().animate({opacity: 1}, 300)
                }, function () {
                    d(".iview-directionNav", a.sliderContent).stop().animate({opacity: a.options.directionNavHoverOpacity}, 300)
            ...
            if (a.options.controlNav) {
                ...
                d(".iview-controlNav", a.sliderContent).css({opacity: a.options.controlNavHoverOpacity});
                a.sliderContent.hover(function () {
                    d(".iview-controlNav", a.sliderContent).stop().animate({opacity: 1}, 300);
                    a.sliderContent.addClass("iview-hover")
                }, function () {
                    d(".iview-controlNav", a.sliderContent).stop().animate({opacity: a.options.controlNavHoverOpacity}, 300);
                ...
                d(".iview-controlNav a.iview-control", a.sliderContent).hover(function () {
                    ...
                    f.stop().animate({left: l, top: b, opacity: 1}, 300);
                    f.not(":visible") && f.fadeIn(300);
                    e.stop().animate({scrollLeft: scrollLeft},
                        300);
                    clearTimeout(g)
                }, function () {
                    var b = d("#iview-tooltip", a.sliderContent);
                    g = setTimeout(function () {
                        b.animate({opacity: 0}, 300, function () {
                            b.hide()
                        })
                    }, 200)
                })
        ...
        setCaption: function () {
            ...
            d(".iview-caption", b).each(function () {
                ...
                b.css({opacity: 0});
                m.css({opacity: 0, position: "relative", width: j, height: l});
                switch (e) {
                    case "wipedown":
                        b.css({top: i - l, left: h});
                        m.css({top: l + 3 * l, left: 0});
                        break;
                    case "wipeup":
                        b.css({top: i + l, left: h});
                        m.css({top: l - 3 * l, left: 0});
                        break;
                    case "wiperight":
                        b.css({top: i, left: h - j});
                        m.css({top: 0, left: j + 2 * j});
                        break;
                    case "wipeleft":
                        b.css({top: i, left: h + j});
                        m.css({top: 0, left: j - 2 * j});
                    ...
                    case "fade":
                        ...
                        break;
                    case "expanddown":
                        b.css({top: i, left: h, height: 0});
                        m.css({top: l + 3 * l, left: 0});
                        break;
                    case "expandup":
                        b.css({top: i + l, left: h, height: 0});
                        m.css({top: l - 3 * l, left: 0});
                        break;
                    case "expandright":
                        b.css({top: i, left: h, width: 0});
                        m.css({top: 0, left: j + 2 * j});
                        break;
                    case "expandleft":
                        b.css({top: i, left: h + j, width: 0}), m.css({top: 0, left: j - 2 * j})
                }
                setTimeout(function () {
                    b.animate({
            ...
            if ("360bar" == this.defs.timer) {
                ...
                this.timerPath.attr({arc: [a, this.R]})
            } else"pie" == this.defs.timer ? (a = 0 == this.pieDegree ? 0 : this.pieDegree + 0.9, this.pieTimer.attr({segment: [a, this.R]})) : this.barTimer.css({width: 100 * (this.pieDegree / 360) + "%"});
            this.pieDegree += 3
            ...
            a.iviewTimer.animate({opacity: a.options.timerOpacity});
            a.pieDegree = 0;
            a.processTimer();
            a.setCaption(a.options);
            ...
            for (var b = b ? b : this.options, c = 0; c < b.strips; c++) {
                ...
                b.strips), e = Math.round(this.slider.height() / b.strips), g = "-" + (f + c * f - f) + "px 0%", k = a ? e * c + "px" : "0px", h = a ? "0px" : f * c + "px";
                a && (g = "0% -" + (e + c * e - e) + "px");
            ...
            this.options.blockCols), b = Math.round(this.slider.height() / this.options.blockRows), c = 0; c < this.options.blockRows; c++)for (var f = 0; f < this.options.blockCols; f++) {
            ...
            switch (a) {
                ...
                case "strip-left-right-down":
                    ...
                    e.each(function () {
                        var a = d(this);
                        0 == f ? (a.css({right: "", left: "0px"}), f++) : (a.css({left: "", right: "0px"}), f = 0);
                        setTimeout(function () {
                            a.animate({
                                width: "100%",
                                opacity: "1.0"
                ...
                case "bottom-curtain":
                    ...
                    e.each(function () {
                        ...
                        "left-curtain" == a || "right-curtain" == a ? e.css({
                            ...
                            height: "100%",
                            width: "0px"
                        }) : e.css({left: "0px", height: "0px", width: "100%"});
                        setTimeout(function () {
                ...
                case "strip-bottom-fade":
                    ...
                    e.each(function () {
                        ...
                        "strip-left-fade" == a || "strip-right-fade" == a ? e.css({
                            ...
                            height: "100%",
                            width: g
                        }) : e.css({left: "0px", height: h, width: "100%"});
                        setTimeout(function () {
                            e.animate({opacity: "1.0"}, 1.7 * b.options.animationSpeed, b.defs.easing, function () {
                                f == b.options.strips - 1 && b.transitionEnd(b);
                                f++
                            })
                        }, 100 + c);
                ...
                case "slide-in-down":
                    ...
                    e.css({top: k, height: "100%", width: b.defs.width});
                    e.animate({top: "0px", opacity: 1}, 2 * b.options.animationSpeed, b.defs.easing, function () {
                        b.transitionEnd(b)
                    });
                    break;
                case "zigzag-top":
                ...
                case "zigzag-drop-bottom":
                    ...
                    for (var h = b.options.blockCols * b.options.blockRows, c = 0, i = [], e = d(".iview-block", b.slider), j = 0; j < b.options.blockRows; j++) {
                        ...
                        if (1 == j % 2)for (var n = l - 1; n >= k; n--)i.push(d(e[n])); else for (n = k; n < l; n++)i.push(d(e[n]))
                    }
                    ...
                    e.each(function (e) {
                        ...
                        a || "zigzag-drop-bottom" == a) && f.css({top: "-=50"});
                        setTimeout(function () {
                            "zigzag-grow-top" == a || "zigzag-grow-bottom" == a ? f.animate({
                                ...
                                e == h - 1 && b.transitionEnd(b)
                            }) : f.animate({opacity: "1"}, 2 * b.options.animationSpeed, "easeInOutExpo", function () {
                                e == h - 1 && b.transitionEnd(b)
                            })
                        }, 100 +
                        c);
                ...
                case "block-drop-random":
                    ...
                    e.each(function (e) {
                        var f = d(this),
                            g = f.height(), k = f.width(), i = f.css("top");
                        "block-expand-random" == a && f.width(0).height(0);
                        "block-drop-random" == a && f.css({top: "-=50"});
                        setTimeout(function () {
                            f.animate({
                                top: i,
                                opacity: "1",
                    ...
                    break;
                default:
                    opts = {strips: 1}, b.addStrips(!1, opts), e = d(".iview-strip:first", b.slider), e.css({
                        height: "100%",
                        width: b.defs.width
                    }), "slide-in-right" == a ? e.css({
                        height: "100%", width: b.defs.width, left: b.defs.width +
                        "px", right: ""
                    }) : "slide-in-left" == a && e.css({left: "-" + b.defs.width + "px"}), e.animate({
                        left: "0px",
                        opacity: 1
            ...
            this.cleanTimer();
            this.iviewTimer.animate({opacity: 0});
            ...
            "random" == this.options.fx.toLowerCase() && (a = "left-curtain right-curtain top-curtain bottom-curtain strip-down-right strip-down-left strip-up-right strip-up-left strip-up-down strip-up-down-left strip-left-right strip-left-right-down slide-in-right slide-in-left slide-in-up slide-in-down fade block-random block-fade block-fade-reverse block-expand block-expand-reverse block-expand-random zigzag-top zigzag-bottom zigzag-grow-top zigzag-grow-bottom zigzag-drop-top zigzag-drop-bottom strip-left-fade strip-right-fade strip-top-fade strip-bottom-fade block-drop-random".split(" "),
                a = a[Math.floor(Math.random() * (a.length + 1))], a == q && (a = "fade"), a = d.trim(a.toLowerCase()));
            ...
            a[b] && this.iviewTimer.css({right: this.options.timerX + "px", left: ""})
    ...
    var o = d([]), p = d.resize = d.extend(d.resize, {}), z, s = "setTimeout", w = "resize", u = w + "-special-event", A = "delay";
    p[A] = 250;
    p.throttleWindow = !0;
    d.event.special[w] = {
        setup: function () {
            ...
            var a = d(this);
            o = o.add(a);
            d.data(this, u, {w: a.width(), h: a.height()});
            1 === o.length && y()
        }, teardown: function () {
            if (!p.throttleWindow && this[s])return !1;
            var a = d(this);
    ...
    var x = !!("ontouchstart"in v), E = x ? "touchstart" : "mousedown",
