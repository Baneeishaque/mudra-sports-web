...
<div class="col-xs-12 col-sm-12 col-md-3 sidebar-resize">
    <aside class="sidebar ">
        ...
        <div class="widget widget-filter">
            <div class="block_content">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-heading"><span class="list-group-heading-inner"> <span> Brands</span> </span>
                    </div>
        ...
        <div class="widget widget-banner"><a href="#"><img src="media/promo/1.jpg" width="270" height="230" alt="img"/></a>
        </div>
...
<div class="col-xs-12 col-sm-12 col-md-9  col-resize ">
    <section class="main-content" role="main">
        ...
        <?php
        include_once './get-products-by-category-brand.php';
        if (isset($_GET['starting_index'])) {
            paginate($_GET['starting_index'], $_GET['count'], $_GET['current_page'], $_GET['name'], $_GET['name2']);
        } else {
            //echo $_GET['name'];
            paginate_init($_GET['name'], $_GET['name2']);
        }
        ?>
        <!-- <li class="  animated"   data-animation="bounceInUp" >
            <div class="product-container ">
                <div class="product-image"> <span class="label-hot">HOT</span>
                    <div class="btn-action-item"> <a href="product_view.html" class="btn-cart  x-hover"> <i class="fa fa-shopping-cart"></i></a> <a href="product_view.html"> <i class="icomoon-heart"></i></a> <a  href="include/product-only-content.html" data-toggle="modal" data-target="#quick-view-id47" > <i class="icomoon-search"></i></a> <a href="media/item/4/5.jpg" class="magnific"> <i class="icomoon-eye-open"></i></a> </div>
                    <img class=""
        ...
        <li class="  animated"   data-animation="bounceInUp" >
            <div class="product-container">
                <div class="product-image">
                    <div class="btn-action-item"> <a href="product_view.html" class="btn-cart  x-hover"> <i class="fa fa-shopping-cart"></i></a> <a href="product_view.html"> <i class="icomoon-heart"></i></a> <a  href="include/product-only-content.html" data-toggle="modal" data-target="#quick-view-id47" > <i class="icomoon-search"></i></a> <a href="media/item/6/26.jpg" class="magnific"> <i class="icomoon-eye-open"></i></a> </div>
                    <img class=""
        ...
        <li class="  animated"   data-animation="bounceInUp" >
            <div class="product-container label-hot-active">
                <div class="product-image"> <span class="label-best">BESTSELLER</span> <div class="label-star">
                    ...
                    <div class="btn-action-item"> <a href="product_view.html" class="btn-cart  x-hover"> <i class="fa fa-shopping-cart"></i></a> <a href="product_view.html"> <i class="icomoon-heart"></i></a> <a  href="include/product-only-content.html" data-toggle="modal" data-target="#quick-view-id47" > <i class="icomoon-search"></i></a> <a href="media/item/8/1.jpg" class="magnific"> <i class="icomoon-eye-open"></i></a> </div>
                    <img class=""
        ...
        <li class="  animated"   data-animation="bounceInUp" >
            <div class="product-container label-not-available-active">
                <div class="product-image"> <span class="label-not-available">not available</span>
                    <div class="btn-action-item"> <a href="product_view.html" class="btn-cart  x-hover"> <i class="fa fa-shopping-cart"></i></a> <a href="product_view.html"> <i class="icomoon-heart"></i></a> <a  href="include/product-only-content.html" data-toggle="modal" data-target="#quick-view-id47" > <i class="icomoon-search"></i></a> <a href="media/item/5/1.jpg" class="magnific"> <i class="icomoon-eye-open"></i></a> </div>
                    <a href="product_view.html"> <img class=""
                                                      src="media/item/5/1.jpg" width="600" height="700" alt="img"/></a> <a href="product_view.html"> <img  class=" slider_img"
